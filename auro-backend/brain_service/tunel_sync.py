"""Aura Brain Mesh - quick tunnel + Railway otomatik senkron.

voice_service/tunel_sync.py'nin birebir kardesi: cloudflared quick tunnel'i
baslatir, cikan trycloudflare adresini yakalar, Railway'de AURA_BRAIN_URL
degiskenini gunceller (Railway degisiklikte otomatik redeploy). Tunnel
koparsa yeniden baslatip tekrar senkronlar.
...
LOCAL_URL = "http://localhost:8130"
RAILWAY_API = "https://backboard.railway.com/graphql/v2"
RAILWAY_VAR = "AURA_BRAIN_URL"
...
def railway_set_var(cfg: dict, name: str, value: str) -> None:
    ...
    req.add_header("User-Agent", "aura-brain-sync/1.0")
...
def _sync_after_delay(cfg: dict, url: str) -> None:
    time.sleep(5)
    try:
        railway_set_var(cfg, RAILWAY_VAR, url)
